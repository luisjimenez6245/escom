...
public class mapperMysql {
    ...
    public Level[] levelList(ResultSet res) {
        try {
            ...
            while (res.next()) {
                li.add(new Level(res.getInt("level_id")).build(res.getBoolean("is_active"), res.getBoolean("is_principal"), res.getBoolean("is_valid"), res.getInt("number"), res.getString("name")));
            }
    ...
    public Database[] databaseList(ResultSet res) {
        try {
            ...
            while (res.next()) {
                li.add(new Database(res.getInt("database_id")).build(null, res.getString("url"), res.getString("name")));
            }
