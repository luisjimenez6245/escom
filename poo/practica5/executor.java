...
public class executor extends Frame {
    ...
    public executor() {
        ...
        botones.add(new Button("Feliz"));
        botones.get(0).addActionListener(eh);
        botones.add(new Button("Enfermo"));
        botones.get(1).addActionListener(eh);
        botones.add(new Button("Asustado"));
        botones.get(2).addActionListener(eh);
        botones.add(new Button("Triste"));
        botones.get(3).addActionListener(eh);
        botones.add(new Button("Enojado"));
        botones.get(4).addActionListener(eh);
        Stirng url = this.getClass().getInstance("");
        routes[0] = "E:\\Usuarios\\Alumno\\Escritorio\\Practica5\\src\\practica5\\carafeliz.jpg";
        routes[1] = "E:\\Usuarios\\Alumno\\Escritorio\\Practica5\\src\\practica5\\caraenfermo.jpg";
        routes[2] = "E:\\Usuarios\\Alumno\\Escritorio\\Practica5\\src\\practica5\\caraasustado.jpg";
        routes[3] = "E:\\Usuarios\\Alumno\\Escritorio\\Practica5\\src\\practica5\\caratriste.jpg";
        routes[4] = "E:\\Usuarios\\Alumno\\Escritorio\\Practica5\\src\\practica5\\caraenojado.jpg";
        ...
        try {
            ...
            while (true) {
                ...
                if (body instanceof String) {
                    b.changeTextureCab(texture, body);
                }
            }
        } catch (Exception e) {
    ...
    void setup3DGraphics() {
        ...
        b = new Body(-0.4f, 0.0f, 0.0f, "", true, this,
                "E:\\Usuarios\\Alumno\\Escritorio\\Practica5\\src\\practica5\\Avatar1");
        b.changeTextureCab(texture, "E:\\Usuarios\\Alumno\\Escritorio\\Practica5\\src\\practica5\\carafeliz.jpg");
    ...
    class EventHandler extends WindowAdapter implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            String route = routes[botones.indexOf(btn)];

            b.changeTextureCab(texture, route);
...
class Body implements Movible {
    ...
    public void disparo1() {
        ...
        /*
         * mar 2017 Vector3f posbala =new Vector3f(0.0f,-0.075f,0f); rl=new
         * RayoLaser(new Vector3d(0,0, 1), null); t3dbala.set(1, new Vector3f(0, 0, 0));
         * rl.setTransform3D(t3dbala);
         * 
         * bgBala1=translate1(rl.getBeamBG(), posbala); tran.addChild(bgBala1);
    ...
    public Point3d getCurrLoc() {
        ...
        System.out.println("Body CUR loc x= (" + trans.x + ") y = (" + trans.y + ") z = (" + trans.z + ")");
        return new Point3d(trans.x, trans.y, trans.z);
    }

    public void moveBy(double x, double z)
    /*
     * Move the sprite by offsets x and z, but only if within the floor and there is
     * no obstacle nearby.
     */
    {
    ...
    public Body(float x, float y, float z, String nombre_mostrar, boolean movimiento, Frame frame,
            String img/* , TransformGroup vTG */) {
        this.x = x;
        this.y = y;
        this.z = z;
        ...
        TextureLoader loader2 = new TextureLoader(
                "E:\\Usuarios\\Alumno\\Escritorio\\Practica5\\src\\practica5\\fondo.jpg", frame);
        ...
        TextureLoader loader1 = new TextureLoader(
                "E:\\Usuarios\\Alumno\\Escritorio\\Practica5\\src\\practica5\\tra.jpg", frame1);
        ...
        Vector3f poshder = new Vector3f(0.085f, 0.115f, 0);
        ...
        /*
         * Transform3D t3dbala=new Transform3D(); t3dbala.set(1,posbala); tgbala=new
         * TransformGroup(t3dbala);
         */
        // tgbala.setCapability(BranchGroup.ALLOW_DETACH);
        /*
         * mar 2017 lb=new LaserBeam(new Vector3d(0,0,0),null); t3dbala=lb.getBeamTD3();
         */

        /*
         * tgbala.addChild(lb.getBeamBG()); bgBala=new BranchGroup();
         ...
         * bgBala.setCapability(BranchGroup.ALLOW_DETACH ); bgBala.addChild(tgbala);
         */
         ...
         * transform3D.setTranslation(vector); Transform3D t3d11HD=new Transform3D();
         * t3d11HD.set(1,posbder); TransformGroup transformGroup =new TransformGroup();
         * transformGroup.setTransform(transform3D); tgbala=new TransformGroup(t3dbala);
         * transformGroup.addChild(node); tgbala.addChild(lb.getBeamBG());
         * 
         * BranchGroup branchGroup=new BranchGroup();
         * branchGroup.setCapability(BranchGroup.ALLOW_DETACH ); bgBala=new
         * BranchGroup(); bgBala.setCapability(BranchGroup.ALLOW_DETACH );
         * branchGroup.addChild(transformGroup); bgBala.addChild(tgbala);
         */

        // Hombro Izquiedo
        Vector3f poshizq = new Vector3f(-0.085f, 0.115f, 0);
        ...
        /*
         * Hombro Izquiedo homizq.setTranslation(poshizq); TransformGroup
         * transformacion5= new TransformGroup(homizq); Sphere hizq=new
         * Sphere(.03f,Primitive.GENERATE_NORMALS, 32,yellowSphAppearance);
         * transformacion5.addChild(hizq); tran.addChild(transformacion5);
         * 
         * Brazo Izquierdo braizq.setTranslation(posbizq); TransformGroup
         * transformacion7= new TransformGroup(braizq); Cylinder bizq=new
         * Cylinder(0.0125f,0.15f ,yellowSphAppearance); transformacion7.addChild(bizq);
    ...
    public void texto(String mensaje, Vector3f v, int tam) {
        ...
        Text2D textObject = new Text2D(mensaje, new Color3f(.4f, 0.4f, 0.6f), "Serif", tam, Font.ITALIC);
    ...
    public void mensaje(String mensaje) {
        ...
        textObject = new Text2D(mensaje, new Color3f(.4f, 0.4f, 0.6f), "Serif", 28, Font.ITALIC);
